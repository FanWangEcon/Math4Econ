...
description: 'local and global maximum.
...
-   **Global Maximum:** Function $f$ defined on domain $X$ has a
    **global** maximum at $x^* \in X$ if for all $x\in X$,
    $f(x)\le f(x^* )$

-   **Local Maximum:** Function $f$ defined on domain $X$ has a
    **local** maximum at $x^* \in X$ if there exists an open interval
...
***Note***: When we combine perference and budget together, like we did
...
![](_img/localglobal_images/figure_0.png){width=500px}
