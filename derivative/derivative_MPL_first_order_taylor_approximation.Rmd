...
description: 'Differential: change along the tangent line to approximate change in
  function value.
...
$\textrm{d}y$ and $\textrm{d}x$ are **differentials**, which are, at
...
$K=1$ and $L=1$, the **slope** of output increase will be $0.5$. The
...
***Exact*** *Solution***:** We can directly calculate this, very hard by
...
Just move the $h$ from the right to the left, the **increase in output**
is *approximately*:
...
What we have just done is called **First Order Taylor Polynomial
