...
%% Cobb-Douglas Production Function Marginal Productivity of Labor
...
YL1 = subs(f, L1)
% Take difference
increase_in_output = YL1 - YL0
% Turn symbolic answer to double (easier to read), increase in output
increase_in_output = double(increase_in_output)
% new level of output
new_level_of_output = double(YL1)
...
new_approximated_level_of_output = 1 + 0.5 * 0.03
%% 
