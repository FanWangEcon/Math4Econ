...
%% Finding Inverse by Hand
% If we append an identity matrix to the right of the coefficient matrix for 
% a system of linear equations, the sequence of elementary row operations that 
% takes the coefficient matrix to its reduced row echelon form will transform 
% the appended identity matrix to the inverse of the coefficient matrix. 
% 
% % 
%